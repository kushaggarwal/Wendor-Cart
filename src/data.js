export const data = [
  ...
  },
  {
    ...
    desc:
      "We hand-pop our farm fresh corn to perfection in honest -to-goodness kettle. Then we lightly sprinkle gourmet quality seasonings at just the right time to enhance the crunch and provide a flavour that you’ll have to try to believe.	",
    img: "/Images/popicorn piri piri/piri masala.jpg",
    images: [
      {
  ...
  {
    name: "Too Yumm Chips ",
    author: "TooYumm! Karare, Chilly Achari",
    price: 20,
    cartQuantity: 0,
    discount: null,
    available: true,
  ...
  },
  {
    ...
    images: [
      {
        img1:
          "/Images/tooyumm chinese hot n sour/tooyumm chinese hot n sour.jpg"
      }
    ],
    desc:
      "Introducing guilt-free snacking with Too Yumm wheat thins. Once you begin, you’ll eat with no sharam. Wondering why? This roasted super snack is filled with fibre, protein and the mouth-watering taste of desi tadka. So yummy and healthy that you’ll eat with no qualms and no sharam. Anytime, anywhere and as much as your heart (and taste buds) desires. So before this pack reaches you, get ready for no sharam eating.",
    img: "/Images/tooyumm chinese hot n sour/tooyumm chinese hot n sour.jpg"
  },
  {
    name: "Too Yumm Chips ",
    ...
    desc:
      "Introducing guilt-free snacking with Too Yumm wheat thins. Once you begin, you’ll eat with no sharam. Wondering why? This roasted super snack is filled with fibre, protein and the mouth-watering taste of desi tadka. So yummy and healthy that you’ll eat with no qualms and no sharam. Anytime, anywhere and as much as your heart (and taste buds) desires. So before this pack reaches you, get ready for no sharam eating.",
    img: "/Images/tooyumm munchy masala/tooyumm munchy masala.jpg"
  },
  {
    name: "Too Yumm Chips ",
    ...
    desc:
      "Introducing guilt-free snacking with Too Yumm wheat thins. Once you begin, you’ll eat with no sharam. Wondering why? This roasted super snack is filled with fibre, protein and the mouth-watering taste of desi tadka. So yummy and healthy that you’ll eat with no qualms and no sharam. Anytime, anywhere and as much as your heart (and taste buds) desires. So before this pack reaches you, get ready for no sharam eating.",
    img: "/Images/tooyumm tangy tomato/tooyumm tangy tomato.jpg"
  },
  {
    name: "YogaBar",
    ...
    img: "/Images/yoga bar cranberry/yoga bar cranberry.jpg"
  },
  {
    name: "YogaBar",
    author: "Yoga bar Whey Protein Bar - Almond Fudge",
    price: 50,
    cartQuantity: 0,
    discount: null,
    available: true,
    images: [
      {
        img1: "/Images/yoga bar almond fudge/yoga bar almond fudge.jpg"
      }
    ],
    desc:
      "To provide you with surplus energy for your workout sessions, the yoga bar protein bars contain: 20g complete protein: whey protein concentrate high biological value, pdcaas 1, lentil protein and almonds. The bars have 0 soy. 10g prebiotic fibre: provides gut microflora and gut health 300 mg omega 3s: alpha-linolenic acid from flax seeds healthy fats: 4: 1 unsaturated to saturated fats ratio lowest net carb: 7 – 8g depending on flavour.",
  ...
  {
    name: "YogaBar",
    author: "Yoga bar Whey Protein Bar - Baked Brownie",
    price: 50,
    cartQuantity: 0,
    discount: null,
    available: true,
  ...
  {
    name: "Unibic Cookies",
    author: "Unibic Fruit & Nut Cookies",
    price: 25,
    cartQuantity: 0,
    discount: null,
    available: true,
...
- Aluminum alloy sound chamber"													`,
    img: "/Images/earphones/earphonesmi/earmi4.jpg",
    id: 36
  },
  {
    name: "Earphones",
...
- Super extra bass- vibe your rhythm all day with fantastic bass heavy tunes that drown out your stress and brings back your search for the ultimate quest, it’s time to get kicking
- Equipped with 3.5 mm angled jack- plug into convenience with the 3.5 mm angled jack to begin your journey, in due time, your boAt will have reached its destination, the shores of nirvana
- Hands-free communication with in-built microphone- communicate seamlessly with the inbuilt mic that has high sensitivity and a versatile frequency range to provide the ultimate experience, Live in the comfort
- Braided tangle free cable- durable and highly resistant, the braided cable adds to the nirvana with its soft feel and tangle resilient features, because wasting time is simply not an option when you’re a boAt head"																						`,
    img: "/Images/earphones/earphonesboat/earboat1.jpg",
    id: 37
  },
  {
    name: "Power Bank",
...
- Mi A1: 2.2 Full Charge and iPhone 7 : 3.5 Full Charge"																`,
    img: "/Images/power bank/mi/pb1.jpg",
    id: 38
  },
  {
    name: "Power Bank",
...
- Dual USB output and support for two phone charger; Power light display, soft light and clear display
- Intelligent power control chip and high conversion rate; Battery power is stored for a long dormant technology; Connector type - input - micro USB 5V/2A, Output - USB 2.0 A 5V/2.1A
- Note: Power bank saves charge by shutting the charging lights after a few seconds while charging the device"																						`,
    img: "/Images/power bank/lenovo/pbo2.jpg",
    id: 39
  },
  {
    name: "Neck Pillow",
...
Made of super soft polifilfiber, adapts perfectly to the shape of the body, provides good support for the cervical vertebrae and the head and prevents head, neck and shoulder pain resulting from sleeping in a seated position."											`,
    img: "/Images/neck pillow/np1.jpg",
    id: 34
  }
];
